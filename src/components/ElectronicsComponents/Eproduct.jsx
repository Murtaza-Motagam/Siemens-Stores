    ...
    const ShowProduct = () => {
        ...
        return (
            <>
                ...
                {/* Detail Container */}
                <div className="col-md-7 mx-auto my-5 px-5" key={product.id}>
                    <h4 className="text-uppercase text-black-50">{product.category}</h4>
                    <h1 className="display-5 font-fam5">{product.name}</h1>
                    {/* <p className="lead fw-bolder font-fam4 fs-5">Rating: {product.rating && product.{product.category}.rate}</p> */}

                    <h3 className="display-6 my-4 font-fam6 px-2">Price: $ {product.price}/-</h3>
                    <p className="text-dark font-fam1 fs-4 my-3 px-2">{product.description}</p>
                    <div className="buttons mt-3 d-flex w-75">
                        <Link to={`/electronics/${product.id}/epaymentgateway`} className="button-66 px-5 text-decoration-none text-white me-2">Buy now</Link>
                ...
                <div className="col-md-5 col-lg-4 order-md-last my-4">
                    ...
                    <ul className="list-group mb-3 my-4">
                        <li className="list-group-item d-flex justify-content-between lh-sm">
                            <div>
                                <h6 className="my-0 px-2">{product.name}</h6>
                            </div>
