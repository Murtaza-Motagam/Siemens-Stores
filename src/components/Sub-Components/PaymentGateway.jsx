                            ...
                            <div className="col-12 mb-4">
                                <div className="row box-right">
                                    <div className="col-md-8 ps-0 ">
                                        <p className=" fw-bold h6 my-2 fs-5 font-fam2  mb-0">{product.title}</p>
                                        <p className="h1 fw-bold d-flex">${product.price}/-</p>
                            ...
                            <div className="h8">
                                <div className="row m-0 border mb-3">
                                    <div className="col-6 h8 pe-0 ps-2">
                                        ...
                                        <span className="d-block py-2 border-bottom">{product.title}</span>
                                    </div>
                                    ...
                                    <div className="col-2 p-0 text-center h8 border-end">
                                        ...
                                        <span className="d-block border-bottom py-2"><span className="fas fa-dollar-sign"></span>{parseInt(product.price)}.00/- </span>
                                    </div>
                                    <div className="col-2 p-0 text-center">
                                        <p className="textmuted p-2">Total</p>
                                        <span className="d-block py-2 border-bottom overflow-hidden"><span className="fas fa-dollar-sign"></span>{parseInt(product.price + 2.5)}.00/- </span> 
                                    </div>
                                </div>
                                <div className="d-flex h7 mb-2">
                                    <p className="">Total Amount</p>
                                    <p className="ms-auto"><span className="fas fa-dollar-sign"></span>{parseInt(product.price + 2.5)}.00/- </p>
                                </div>
                                ...
                                <div className="form">
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="card border-0 fs-5"> <input className="form-control fs-5" type="text" placeholder=" &#128179; Card number" /></div>
                                        </div>
                                    ...
                                    <button className="btn btn-primary py-2 w-100 text-center font-fam3 fs-5 p-0"><span className="fas fa-dollar-sign"></span> PAY {parseInt(product.price + 2.5)}.00 &rarr;</button>
                                </div>
                            </div>
                        </div>
                    </div>
